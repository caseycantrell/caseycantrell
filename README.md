![header](https://capsule-render.vercel.app/api?type=waving&color=0:EEFF00,100:a82da8&height=160&section=header&text=Casey%20Cantrell&animation=fadeIn&fontSize=40&fontColor=ffffff&fontAlignY=30)
```js
const caseyCantrell = {
